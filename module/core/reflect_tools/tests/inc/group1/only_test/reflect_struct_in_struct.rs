...
fn reflect_struct_in_struct()
{
  ...
  a_id!( reflect::reflect( &ins ).type_name(), "tests::inc::group1::struct_in_struct_manual_test::Struct1" );
  ...
  a_id!( f3.val.len(), 3 );
  a_id!( f3.val.type_name(), "tests::inc::group1::struct_in_struct_manual_test::Struct2" );
